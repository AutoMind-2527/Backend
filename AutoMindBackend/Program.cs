...
builder.Services
    ...
    {
        options.Authority = "https://keycloak-service:8080/keycloak/realms/automind-realm";
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.AddSecurityDefinition("oauth2", new OpenApiSecurityScheme
    {
        ...
        Flows = new OpenApiOAuthFlows
        {
            ...
            {
                TokenUrl = new Uri("https://keycloak-service:8080/keycloak/realms/automind-realm/protocol/openid-connect/token"),
